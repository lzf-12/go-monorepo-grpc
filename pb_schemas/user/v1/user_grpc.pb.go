...
const (
	UserService_ValidateToken_FullMethodName = "/pb_schemas.user.v1.UserService/ValidateToken"
)
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb_schemas.user.v1.UserService",
	...
	Metadata: "pb_schemas/user/v1/user.proto",
}
